	...
	if (width < 510 || height < 510)
	{
		...
		if (disable_mobile_layout == 1)
		{
			if ( jQuery('body').hasClass('home')) {
				jQuery('.mask-loading').css('display','none');
				jQuery('.row-designer-tool').html('<div class="goto_design" style="background:#ddd !important;text-align:center !important;"><a href="https://www.notjustabottle.tokyo/design-your-own/">Design</a></div>');
			} else {
