...
function wc_get_account_orders_columns() {
	$columns = apply_filters(
		...
		array(
			'order-number'  => __( 'オーダー番号', 'woocommerce' ),
			'order-date'    => __( '日付', 'woocommerce' ),
			'order-status'  => __( 'ステータス', 'woocommerce' ),
			'order-total'   => __( '中音内容', 'woocommerce' ),
			'order-actions' => __( '詳細', 'woocommerce' ),
		)
	);
