<div class="wrap">
	...
	$this->wc4jp_plugin->do_settings_sections( 'wc4jp_informations' );
?>
		</div>
		</form>
		<div class="clear"></div>
	...
	<p><?php echo sprintf(__('The currently working framework version is %s.', 'woocommerce-for-japan'), WC4JP_FRAMEWORK_VERSION);?><br />
	</p>
	<p>
