	...
	<div class="wc4jp-settings metabox-holder">
		<div class="wc4jp-sidebar">
			<div class="wc4jp-credits">
				...
				<div class="inside">
					<?php $this->wc4jp_plugin->wc4jp_support_notice('https://support.artws.info/forums/forum/wordpress-official/woocommerce-for-japan-plugins-forum/');?>
					<hr />
					<?php $this->wc4jp_plugin->wc4jp_update_notice();?>
					<hr />
					<?php $this->wc4jp_plugin->wc4jp_community_info();?>
					...
					<?php endif;?>
					<hr />
					<?php $this->wc4jp_plugin->wc4jp_author_info();?>
				</div>
			</div>
		</div>
...
<?php
	...
	$this->wc4jp_plugin->do_settings_sections( $section );
?>
			<p class="submit">
<?php
