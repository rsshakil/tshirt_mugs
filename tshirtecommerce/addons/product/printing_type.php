...
?>
<?php if(isset($product->allow_change_printing_type) && count($print_types)) { ?>
<div id="printing-type" class="form-group product-fields" <?php if($print_type['title'] == '') echo 'style="display:none;"'; ?>>
	<label><?php echo $addons->__('addon_print_type_title'); ?>: <a href="javascript:void(0);" onclick="jQuery('.printing-type-current-modal').modal('show');"><?php echo $addons->__('addon_print_type_view'); ?></a></label>
