...
jQuery(document).ready(function() {	
	...
	if(filterLink.length == 0) 
	{
		...
		jQuery('#options-add_item_clipart .dg-options-toolbar .btn-group').append('<div class="btn btn-default" id="filter-link-cus" data-type="filter" onclick="showFilterList()"><i class="fa fa-heart"></i> '+ shapelabelbtn +'</div>');
