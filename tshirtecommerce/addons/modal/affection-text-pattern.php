			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12 text-filter-area">
						<?php
							echo '<a class="filter-box" href="javaScript:void(0)" onclick="removePattern(this)"><svg viewBox="0 0 94 33" width="160" height="60" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="none"><text stroke="none" stroke-width="0" stroke-linecap="round" stroke-linejoin="round" text-anchor="middle" x="27" y="24" font-size="20px"><tspan dy="0" x="50%">NORMAL</tspan></text></svg>NORMAL</a>';
