...
if (typeof window.parent.design_platform !== 'undefined') {
	if (window.parent.design_platform == 'prestashop') {
		url_ajax_products = '/modules/tshirtecommerce/ajax.php?method=products';
	} else if (window.parent.design_platform == 'opencart') {
		url_ajax_products = 'index.php?route=tshirtecommerce/designer/ajax';
	}
}
var gallery = {
	type: 'simple',
