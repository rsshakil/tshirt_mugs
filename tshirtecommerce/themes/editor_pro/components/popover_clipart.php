...
<div id="options-add_item_clipart" class="dg-options">
	<div class="dg-options-toolbar">
		...
		<div class="pull-right">
			...
			<button class="btn btn-default btn-sm" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang('designer_js_copy'); ?>" onclick="design.tools.copy(this);">
			...
			<button class="btn btn-default btn-sm" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang('designer_tools_full'); ?>" onclick="design.tools.fullPage();">
				<i class="glyph-icon flaticon-expand-2 flaticon-14"></i>
			</button>

			<button class="btn btn-default btn-sm" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang('designer_tools_fit'); ?>" onclick="design.tools.fit();">
				<i class="glyph-icon flaticon-expand-1 flaticon-14"></i>
			</button>

			<button class="btn btn-default btn-sm" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang('designer_clipart_edit_flip'); ?>" onclick="design.tools.flip('x');">
				<i class="glyph-icon flaticon-reflect flaticon-14"></i>
			</button>

			<button class="btn btn-default btn-sm" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang('designer_team_remove'); ?>" onclick="design.tools.remove();">
