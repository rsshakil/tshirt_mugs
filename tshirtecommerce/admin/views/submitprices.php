			...
			?>
				<tr>
					...
					<td class="center">
						...
						<a class="btn btn-xs btn-default btn-quote-addon" href="<?php echo $product->url; ?>" target="_blank"><?php echo $addons->__('addon_submit_price_share_design') ?></a>
						<?php if (isset($product->download) && count($product->download)) { ?>
						<div class="dropdown">
  							<button class="btn btn-xs btn-default dropdown-toggle btn-quote-addon" type="button" id="dropdownMenuDlink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
    							<?php echo $addons->__('addon_submit_price_download_design') ?>
    							<span class="caret"></span>
  							</button>
  							<ul class="dropdown-menu" aria-labelledby="dropdownMenuDlink">
  								<?php foreach ($product->download as $dview => $dlink) { ?>
							    <li><a href="<?php echo $dlink ?>" target="_blank"><?php echo $dview ?></a></li>
							    <?php } ?>
  							</ul>
						</div>
						<?php } ?>
