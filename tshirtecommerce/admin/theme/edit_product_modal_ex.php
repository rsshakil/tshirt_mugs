			...
			<div class="tab-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="col-sm-3 control-label"><?php lang('product_categories'); ?></label>
								<div class="col-sm-8">
										...
										<div class="add-new-category" style="display:none;">
											...
											<div class="form-group">
												<select class="form-control" id="product-category-parent">
													...
													<?php echo $dgClass->dispayTree( $categories, 0, array('type'=>'select', 'name'=>'') ); ?>
												</select>
											</div>
				...
				<div class="tab-pane" id="panel-variations">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<a href="javascript:void(0);" class="btn btn-primary text-white btn-variation">Add New Variation</a>
						</div>
					</div>
					<?php } ?>
					...
					<?php if(count($child)) { ?>
						...
						<div class="gallery-box">
							<a href="javascript:void(0)" data-id="<?php echo $product_child['id']; ?>" class="btn btn-primary btn-variation">
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		if(typeof parent.window.url_product_design != 'undefined')
		{
			var url_product_design = parent.window.url_product_design;
			url_product_design = url_product_design +'/'+product_id;
			jQuery('.btn-variation').click(function() {
				if(jQuery(this).data('id') != undefined)
				{
					url_product_design = url_product_design +'/'+ jQuery(this).data('id');
				}
				var win = window.parent.open(url_product_design, '_blank');
  				win.focus();
			});
		}
	});
