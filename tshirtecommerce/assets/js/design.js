	...
	print:{
		colors:function(view){
			...
			jQuery('#app-wrap'+view).find('svg').each(function(){
				...
				if(typeof o != 'undefined' && o.item != undefined && typeof o.item.confirmColor != 'undefined' && o.item.confirmColor == true && typeof o.item.colors != 'undefined')
				{
						...
						jQuery.each(item, function(j, e){
							if (typeof e.id != 'undefined' && e.id != 'area-design')
							{
								...
								var img	= document.createElement('img');
									...
									if( (typeof e.is_change_color != 'undefined' && e.is_change_color == 1) || (change_bg_product == 'img' && e.is_product != undefined && e.is_change_color == 1) )
									{
